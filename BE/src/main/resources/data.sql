...
INSERT INTO DataProducts (shortKey, title, shortDescription, description, source, sourceLink, lastUpdated, categoryId, accessRightId) VALUES
    ('immobilien', 'Immobilien Inserate', 'Immobilien Inserate (z.B. für Nürnberg von WG Suche seit April 2023)', 'Der Datensatz enthält grundlegende Daten von Immobilienanzeigen', 'Immobilienanzeigen WG-Suche, ...', 'https://api.wg-suche.de/v1_3/, ...', TIMESTAMP '2023-04-12 00:00:00', (SELECT id FROM DataProduct_Categories WHERE category = 'Immobilien'), (SELECT id FROM DataProduct_AccessRights WHERE accessRight = 'gratis'));