...
public class DataProductInsightRepository {
    ...
    public InsightFilterDTO getFilterById(long id, int filterId) {
    ...
    public boolean insertInsights(long id, DataProductInsightDataDTO[] dto){
    ...
    public boolean deleteInsights(long id){
    ...
    public InsightFilterDTO[] getInsightFiltersData(long id){
    ...
    public boolean insertInsightsFilter(long id, InsightFilterDTO[] dto){
    ...
    public boolean deleteInsightsFilter(long id){
